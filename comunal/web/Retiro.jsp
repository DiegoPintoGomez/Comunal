...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <section class="box2">
            <h1>Retiro</h1>
            <form id="Retiro" action="GenerarRetiro" method="POST" class="Formularios">
            ...
            %>
            <form id="aplicar" action="aplicarRetiro" method="POST" class="Formularios">
                <table class="formulario">
                    <tbody>
                        <tr>
                            <td>
                                <label for="valor">Seleccione la cuenta a Retiro:</label>
                            </td>
                            <td>
